...
def calculate_metrics(data, bond_yield_series=None):
    ...
    for date, price in weekly_prices.items():
        ...
        if use_quarterly:
            ...
            cash      = _bs_val(q_bs, ['Cash And Cash Equivalents',
            ...
            cash     = _bs_val(a_bs, ['Cash And Cash Equivalents',
                                       'Cash Cash Equivalents And Short Term Investments'], anchor)
